...
const {encrypt, decrypt, getEpoch} = require('../src/activate_utils');

const APP_ID = 'warping';
...
router.post('/init', function(req, res) {
  ...
  .then((data)=>{
    ...
    system_id = system_id.substr(0, 32);
